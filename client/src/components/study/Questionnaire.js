...
import apm_item_1_1 from "./images/Item_1_1.png";
          ...
          elements: [
            {
              ...
              title: {
                de:
                  "Bitte wählen Sie das Element aus, welches das darüber abgebildete Bild korrekt ergänzt."
              },
              isRequired: this.state.requiredQ,
              colCount: 4,
              choices: [
                {
                  value: "Element1",
                  imageLink: ".1_1.png/images/Item_"
                },
                {
                  value: "Element2",
            ...
            },
            {
              ...
              name: "info",
              html:
                "<table><body><row><td><img src='./images/Item_1_0.png' width='100' alt='Test Item 1' /></td><td style='padding:20px'>You may put here any html code. For example images, <b>text</b> or <a href='https://surveyjs.io/create-survey'  target='_blank'>links</a></td></row></body></table>"
            }
          ]
        },
        {
